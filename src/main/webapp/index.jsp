...
<head>
  ...
  <title>Manoj needs to learn these Courses Demo</title>
  <style>
    body {
...
<body>
  ...
  <header>
    <h1>🚀 Manoj needs to learn these Courses</h1>
    <p>Upgrade your career with industry-ready training programs</p>
  </header>
